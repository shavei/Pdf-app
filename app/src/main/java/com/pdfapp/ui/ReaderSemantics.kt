 ...
 * F.2). Kept free of Compose — like [ReaderChrome], [ReaderBack] and
 * [ReaderLayout] — so the phrasing is unit-testable on the JVM and the controls
 * that exist twice (bottom bar *and* nav rail, modal sheet *and* docked pane)
