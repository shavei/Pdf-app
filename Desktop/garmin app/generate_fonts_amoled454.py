"""
Generate Hebrew bitmap fonts for AMOLED round 454x454 devices
(fenix 8 47mm, Forerunner 965, Venu 3).
Slightly larger than the Instinct 3 AMOLED (390/416px) sizes.
...
out = r"C:\Users\yosef\Desktop\garmin app\resources-amoled454\fonts"
print("Generating AMOLED-454 Hebrew fonts (NotoSansHebrew)...")
generate_fnt("HebrewSmall",  38, out)   # titles, labels
generate_fnt("HebrewMedium", 52, out)   # content
generate_fnt("HebrewLarge",  68, out)   # date display
