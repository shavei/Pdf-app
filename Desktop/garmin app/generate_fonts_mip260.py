"""
Generate Hebrew bitmap fonts for MIP round 260x260 devices
(fenix 7, Forerunner 255, Forerunner 955).
Sized between Solar (176px) and AMOLED (390px).
...
out = r"C:\Users\yosef\Desktop\garmin app\resources-mip260\fonts"
print("Generating MIP-260 Hebrew fonts (NotoSansHebrew)...")
generate_fnt("HebrewSmall",  24, out)   # titles, labels
generate_fnt("HebrewMedium", 32, out)   # content
generate_fnt("HebrewLarge",  42, out)   # date display
